...
def rag_with_reasoner(user_query: str) -> str:
    """
    This is a Farmer Assistance Model that uses context from a vector database to answer a user's question on best farming practices based on climate information. 
    ...
    If there isn't sufficient information, give as your answer a better query to search the vector database with.
